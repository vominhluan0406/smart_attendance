...
// HasMethod checks if the branch allows a specific check-in method.
func (b *Branch) HasMethod(method CheckInMethod) bool {
	methods := strings.Split(b.AllowedMethods, ",")
