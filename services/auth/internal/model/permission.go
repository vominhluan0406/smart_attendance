...
type RolePermission struct {
	BaseModel
	Role         Role   `gorm:"type:varchar(50);not null;index:idx_rp_role_perm,unique" json:"role"`
	PermissionID string `gorm:"type:uuid;not null;index:idx_rp_role_perm,unique" json:"permission_id"`
